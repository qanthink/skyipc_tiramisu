...
#define MI_ISP_NAME ISP_IKAYAKI
...
typedef struct
{
    MI_U8 u8IIR1En;
    MI_U8 u8IIR2En;
    MI_U8 u8Cor;  //0, 1, 2, 3: 0x, 1x, 2x, 4x
    MI_U8 u8Hor;  //0, 1, 2, 3: 0x, 1x, 2x, 4x
    MI_U8 u8Vert; //0, 1, 2, 3: 0x, 1x, 2x, 4x
    MI_U8 u8Cent; //0, 1, 2, 3: 1x, 2x, 4x, 8x
    MI_U8 u8Div;  //0, 1, 2, 3: 1/8x, 1/16x, 1/32x, 1/64x
} CusAFPreFilter_t;
