...
#define MI_ISP_API_ISPMID_NOT_SUPPORT   (5)
    ...
    MI_S32 MI_ISP_CUS3A_SetAFFilter_Geo(MI_U32 DevId, MI_U32 Channel, CusAFFilter_Geo_t *data);
    MI_S32 MI_ISP_CUS3A_GetAFFilter_Geo(MI_U32 DevId, MI_U32 Channel, CusAFFilter_Geo_t *data);
    ...
    MI_S32 MI_ISP_CUS3A_SetAFRoiMode(MI_U32 DevId, MI_U32 Channel, CusAFRoiMode_t *data);
    MI_S32 MI_ISP_CUS3A_GetAFRoiMode(MI_U32 DevId, MI_U32 Channel, CusAFRoiMode_t *data);
    ...
    MI_S32 MI_ISP_SET_ALL(MI_U32 DevId, MI_U32 Channel, MI_U16 ApiId, MI_U32 ApiLen, MI_U8* pApiBuf);
    MI_S32 MI_ISP_GET_ALL(MI_U32 DevId, MI_U32 Channel, MI_U16 ApiId, MI_U32* ApiLen, MI_U8* pApiBuf);

    typedef MI_S32 (*MI_ISP_ApiAgent_fp)(MI_ISP_IQApiHeader_t *pstData, void* pData);

    /*Api agent for SigmaStar user space 3A library*/
    MI_S32 MI_ISP_RegisterIspApiAgent(MI_U32 Dev, MI_U32 Channel, MI_ISP_ApiAgent_fp fpApiSet, MI_ISP_ApiAgent_fp fpApiGet);
    ...
    MI_S32 MI_ISP_API_CmdLoadBinFile(MI_U32 DevId, MI_U32 Channel, char* filepath, MI_U32 user_key);
    MI_S32 MI_ISP_API_CmdLoadCaliData(MI_U32 DevId, MI_U32 Channel, MI_ISP_CALI_ITEM_e eCaliItem, char* filepath);
#else //for DualOS-Linux , RTK
    inline MI_S32 MI_ISP_EnableUserspace3A(MI_U32 DevId, MI_U32 Channel) {return 0;}
    inline MI_S32 MI_ISP_DisableUserspace3A(MI_U32 DevId, MI_U32 Channel) {return 0;}
#endif
