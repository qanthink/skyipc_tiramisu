	 ...
	 */
		switch(cs)
		{
			case UVC_PU_BRIGHTNESS_CONTROL:
			{
				...
				break;
			}	// end of UVC_PU_BRIGHTNESS_CONTROL
			...
			case UVC_PU_BACKLIGHT_COMPENSATION_CONTROL:
			{
				...
				case UVC_GET_CUR:
					resp->length = 2;
					resp->data[0] = pu_backlight_compensation_data[0];
					resp->data[1] = pu_backlight_compensation_data[1];
					pdev->request_error_code.data[0] = 0x00;
					pdev->request_error_code.length = 1;
					break;
				case UVC_GET_MIN:
				...
				case UVC_GET_DEF:
					resp->length = 2;
					pu_backlight_compensation_data[0] = resp->data[0] = 0x00;
					pu_backlight_compensation_data[1] = resp->data[1] = 0x00;
					pdev->request_error_code.data[0] = 0x00;
					pdev->request_error_code.length = 1;
					break;
				/* not support GET_LEN cmd */
			...
			case UVC_PU_CONTRAST_CONTROL:
			{
				...
				case UVC_GET_CUR:
					resp->length = 2;
					resp->data[0] = pu_contrast_data[0];
					resp->data[1] = pu_contrast_data[1];
					pdev->request_error_code.data[0] = 0x00;
					pdev->request_error_code.length = 1;
					break;
				case UVC_GET_MIN:
				...
				case UVC_GET_DEF:
					...
					pu_contrast_data[1] = resp->data[1] = 0x00;
					pdev->request_error_code.data[0] = 0x00;
					pdev->request_error_code.length = 1;
					break;
				/* not support GET_LEN cmd */
			...
			case UVC_PU_GAIN_CONTROL:
			{
				...
				case UVC_GET_CUR:
					resp->length = 2;
					resp->data[0] = pu_gain_data[0];
					resp->data[1] = pu_gain_data[1];
					pdev->request_error_code.data[0] = 0x00;
					pdev->request_error_code.length = 1;
					break;
				case UVC_GET_MIN:
				...
				case UVC_GET_DEF:
					resp->length = 2;
					pu_gain_data[0] = resp->data[0] = 0x00;
					pu_gain_data[1] = resp->data[1] = 0x00;
					pdev->request_error_code.data[0] = 0x00;
					pdev->request_error_code.length = 1;
					break;
				/* not support GET_LEN cmd */
			...
			case UVC_PU_HUE_CONTROL:
			{
				...
				case UVC_GET_CUR:
					resp->length = 2;
					resp->data[0] = pu_hue_data[0];
					resp->data[1] = pu_hue_data[1];
					pdev->request_error_code.data[0] = 0x00;
					pdev->request_error_code.length = 1;
					break;
				case UVC_GET_MIN:
				...
				case UVC_GET_DEF:
					resp->length = 2;
					pu_hue_data[0] = resp->data[0] = 0x00;
					pu_hue_data[1] = resp->data[1] = 0x00;
					pdev->request_error_code.data[0] = 0x00;
					pdev->request_error_code.length = 1;
					break;
				/* not support GET_LEN cmd */
			...
			case UVC_PU_SATURATION_CONTROL:
			{
				...
				case UVC_GET_CUR:
					resp->length = 2;
					resp->data[0] = pu_saturatio_data[0];
					resp->data[1] = pu_saturatio_data[1];
					pdev->request_error_code.data[0] = 0x00;
					pdev->request_error_code.length = 1;
					break;
				case UVC_GET_MIN:
				...
				case UVC_GET_DEF:
					resp->length = 2;
					pu_saturatio_data[0] = resp->data[0] = 0x00;
					pu_saturatio_data[1] = resp->data[1] = 0x00;
					pdev->request_error_code.data[0] = 0x00;
					pdev->request_error_code.length = 1;
					break;
				/* not support GET_LEN cmd */
			...
			case UVC_PU_SHARPNESS_CONTROL:
			{
				...
				case UVC_GET_CUR:
					resp->length = 2;
					resp->data[0] = pu_sharpness_data[0];
					resp->data[1] = pu_sharpness_data[1];
					pdev->request_error_code.data[0] = 0x00;
					pdev->request_error_code.length = 1;
					break;
				case UVC_GET_MIN:
				...
				case UVC_GET_DEF:
					resp->length = 2;
					pu_sharpness_data[0] = resp->data[0] = 0x00;
					pu_sharpness_data[1] = resp->data[1] = 0x00;
					pdev->request_error_code.data[0] = 0x00;
					pdev->request_error_code.length = 1;
					break;
				/* not support GET_LEN cmd */
			...
			case UVC_PU_GAMMA_CONTROL:
			{
				...
				case UVC_GET_CUR:
					resp->length = 2;
					resp->data[0] = pu_gamma_data[0];
					resp->data[1] = pu_gamma_data[1];
					pdev->request_error_code.data[0] = 0x00;
					pdev->request_error_code.length = 1;
					break;
				case UVC_GET_MIN:
				...
				case UVC_GET_DEF:
					resp->length = 2;
					pu_gamma_data[0] = resp->data[0] = 0x00;
					pu_gamma_data[1] = resp->data[1] = 0x00;
					pdev->request_error_code.data[0] = 0x00;
					pdev->request_error_code.length = 1;
					break;
				/* not support GET_LEN cmd */
			...
			case UVC_PU_WHITE_BALANCE_TEMPERATURE_CONTROL:
			{
				...
				case UVC_GET_CUR:
					resp->length = 2;
					resp->data[0] = pu_white_balance_temperature_data[0];
					resp->data[1] = pu_white_balance_temperature_data[1];
					pdev->request_error_code.data[0] = 0x00;
					pdev->request_error_code.length = 1;
					break;
				case UVC_GET_MIN:
			...
			#endif	// end of white_balance_temperature
			#if 1
			...
			#endif	// end of white_balance_temperature_auto
			...
			default:
			{
				...
				pdev->request_error_code.length = 1;
				break;
			} // end default, not brightness, not hue, not saturatio...
		}// end switch cs, cs = brightness, hue, saturatio...
		break;
	} // end switch PU, UVC_VC_PROCESSING_UNIT_ID
