...
static struct UVC_FRAME_MJPEG(3) uvc_frame_mjpg_48mp = {
	...
	.bFrameIndex		= 7,
	.bmCapabilities		= 0,
	.wWidth			= cpu_to_le16(7200),
	.wHeight		= cpu_to_le16(5400),
	.dwMinBitRate		= cpu_to_le32(7200*5400*2*10),
	.dwMaxBitRate		= cpu_to_le32(7200*5400*2*10), //overflow
	.dwMaxVideoFrameBufferSize	= cpu_to_le32(7200*5400*2),
