...
MI_S32 ST_GetTimingInfo(ST_DispoutTiming_e s32ApTiming, MI_HDMI_TimingType_e *ps32HdmiTiming, MI_DISP_OutputTiming_e *ps32DispTiming, MI_U32 *pu16DispW, MI_U32 *pu16DispH);

void ST_List_Sort(void *priv, struct list_head *head, int (*cmp)(void *priv, struct list_head *a, struct list_head *b));
